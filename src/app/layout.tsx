...
export default function SwapPage() {
  ...
  const pill = 'rounded-full border border-white/15 bg-white/5 px-4 py-2 text-sm hover:bg-white/10 transition text-white no-underline'
      ...
      <header className="mx-auto max-w-7xl px-6 pt-6">
        <div className="flex items-center justify-between rounded-2xl border border-white/10 bg-black/30 backdrop-blur-md px-4 py-3">
          <div className="flex items-center gap-3">
            <div className="font-semibold tracking-wide text-white">PHUCK<span style={{color:'#c8ff00'}}>MC</span></div>
            <div className="text-xs text-white/50">swap</div>
          </div>
          <nav className="hidden md:flex items-center gap-2">
            <Link href="/" className={pill}>Home</Link>
            <Link href="/swap" className="rounded-full border border-white/10 bg-white/10 px-4 py-2 text-sm text-white">Swap</Link>
            <Link href="/staking" className={pill}>Staking</Link>
            <Link href="/predictions" className={pill}>Predictions</Link>
            <a href="https://t.me/PhuckMc" target="_blank" rel="noreferrer" className={pill}>Telegram</a>
            <a href="https://t.me/PhuckMc/74931" target="_blank" rel="noreferrer" className={pill}>𝕏</a>
          </nav>
          <WalletButton />
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          <div className="md:col-span-3">
            <Card>
              ...
              <div className="mt-3 text-xs text-white/40">Fee router takes 1% and forwards the rest to nad.fun DEX.</div>
              ...
              {status === 'pending' && txHash && <div className="mt-4 rounded-xl border border-white/10 bg-black/30 px-4 py-3 text-white/60 text-sm">⏳ Waiting…</div>}
            ...
            <Card>
              ...
              {statsErr ? (
                <div className="rounded-xl border border-white/10 bg-black/30 p-4 text-white/50 text-sm">
                  ...
                  <div className="mt-2 text-xs text-white/35">Set <code>FEE_API_BASE</code> in Vercel env vars.</div>
                </div>
              ) : (
